...
def new_store():
    ...
    return render_template('main/new_store.html', form=form)
...
def item_detail(item_id):
    ...
    return render_template('main/item_detail.html', item=item, form=form)
...
def shopping_list():
    ...
    return render_template('main/shopping_list.html', items=items)